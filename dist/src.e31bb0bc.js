...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/image1.png":[function(require,module,exports) {
...
var text = "\n\u041A\u0440\u0443\u0442\u044B\u0435 \u0432\u0438\u0434\u0435\u043E \u0438 \u0443\u0440\u043E\u043A\u0438 \u043F\u043E JavaScript \u043A\u043E\u0442\u043E\u0440\u044B\u0435 \u0442\u044B \u043F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u043B: <a href=\"https://youtube.com/c/Soyuzmultfilm\" target=\"_blank\">YuTuppe</a>. \u0422\u0443\u0442 \u0442\u044B \u043D\u0430\u0439\u0434\u0435\u0448\u044C \u0438\u0441\u0447\u0435\u0440\u043F\u044B\u0432\u0430\u044E\u0449\u0443\u044E \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E \u043F\u043E \u043B\u044E\u0431\u044B\u043C \u0430\u0441\u043F\u0435\u043A\u0442\u0430\u043C \u044F\u0437\u044B\u043A\u0430, \u043B\u044E\u0431\u044B\u043C \u0444\u0440\u0435\u0439\u043C\u0432\u043E\u0440\u043A\u0430\u043C, \u0442\u0430\u043A\u0438\u0435 \u043A\u0430\u043A: React, Vue, Angular, Node, Svelte, Express, Next, Nuxt \u0438 \u043C\u043D\u043E\u0433\u043E\u0435 \u0434\u0440\u0443\u0433\u043E\u0435. \u041F\u0440\u0438\u0441\u043E\u0435\u0434\u0438\u043D\u044F\u0439\u0441\u044F!\n";
var model = [new _blocks.TitleBlock("Construct your Websites using JavaScript", {
  tag: 'h2',
  styles: {
  ...
  alt: 'Kartinkoo'
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотекПриложение на чистом JavaScript, без использования библиотекПриложение на чистом JavaScript, без использования библиотекПриложение на чистом JavaScript, без использования библиотекПриложение на чистом JavaScript, без использования библиотекПриложение на чистом JavaScript, без использования библиотек', 'Узнаешь как работают принципы SOLID и ООП в JavaScript за один курсУзнаешь как работают принципы SOLID и ООП в JavaScript за один курсУзнаешь как работают принципы SOLID и ООП в JavaScript за один курсУзнаешь как работают принципы SOLID и ООП в JavaScript за один курсУзнаешь как работают принципы SOLID и ООП в JavaScript за один курсУзнаешь как работают принципы SOLID и ООП в JavaScript за один курс', 'JavaScript - это просто, интересно. Научись создавать любые UI своими рукамиJavaScript - это просто, интересно. Научись создавать любые UI своими рукамиJavaScript - это просто, интересно. Научись создавать любые UI своими рукамиJavaScript - это просто, интересно. Научись создавать любые UI своими рукамиJavaScript - это просто, интересно. Научись создавать любые UI своими руками'], {
  styles: {
...
exports.model = model;
},{"./assets/image1.png":"assets/image1.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
...
},{"./model":"model.js","./classes/app":"classes/app.js","./main.css":"main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
